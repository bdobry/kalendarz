...
export const SeoContent: React.FC = () => {
  return (
    <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mt-12 mb-8">
      <div className="prose prose-slate max-w-none">
        ...
        <div className="mt-6 p-4 bg-indigo-50 rounded-xl border border-indigo-100">
          <h4 className="text-indigo-900 font-semibold mb-2">Dlaczego warto planować z NieRobie.pl?</h4>
