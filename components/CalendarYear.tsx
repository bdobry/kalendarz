...
export function CalendarYear({ year, efficiencyClass, interactive, ready, primary, showEfficiency = true, onChange }: {
  year: number;
  ...
  return <div className="calendar-year-context">
    ...
    {showEfficiency && <div className="calendar-efficiency" onMouseEnter={() => setShowTooltip(true)} onMouseLeave={() => setShowTooltip(false)} onKeyDown={event => { if (event.key === 'Escape') setShowTooltip(false); }}>
