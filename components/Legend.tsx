    ...
    <div className="mt-8 border-t border-slate-200 bg-white/40 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div className="flex flex-wrap justify-between items-center gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-2">
             <div className="w-8 h-6 rounded-[5px] bg-brand-50/40 border border-brand-100 text-brand-600 font-bold flex items-center justify-center relative">
               <span className="absolute top-1 right-1 h-1 w-1 rounded-full bg-brand-600"></span>
               1
             </div>
             <span>Święto</span>
          </div>
          ...
          <div className="flex items-center gap-2">
             <div className="flex items-center">
                <div className="w-5 h-6 bg-brand-50 border border-brand-100 border-r-0 rounded-l-[5px] flex items-center justify-center text-[10px] text-brand-900/70">Pt</div>
                <div className="w-5 h-6 bg-brand-50 border-y border-brand-100 flex items-center justify-center text-[10px] font-bold text-brand-700">Sb</div>
                <div className="w-5 h-6 bg-brand-50 border border-brand-100 border-l-0 rounded-r-[5px] flex items-center justify-center text-[10px] text-brand-900/70">Nd</div>
             </div>
          ...
          <div className="flex items-center gap-2">
             <div className="flex items-center">
                ...
                <div className="w-5 h-6 bg-brand-50 border border-brand-100 border-l-0 rounded-r-[5px] flex items-center justify-center text-[10px] text-brand-900/70">Wt</div>
             </div>
