...
export const DonationIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
    <path d="M8 1.5C6.7 3.7 3.5 6.9 3.5 9.5a4.5 4.5 0 0 0 9 0C12.5 6.9 9.3 3.7 8 1.5Z" />
    <path d="M6 9.5A2 2 0 0 0 8 11.5" />
  </svg>
);
